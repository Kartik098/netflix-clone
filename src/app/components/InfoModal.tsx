        ...
        <div className={`
            ...
            >
                <div className="relative h-96">
                    ...
                    brightness
                    object-cover
                    h-full' autoPlay muted loop poster={data?.thumbnailUrl} src={data?.videoUrl}>
                    ...
                    <div className="absolute bottom-[10%] left-10">
                        <p className='text-white text-3xl md:text-4xl h-full lg:text-5xl font-bold mt-8'>{data?.title}</p>
